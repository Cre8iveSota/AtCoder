...
namespace x
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #endregion
            // if it were target one, it deserve as true, if not is false;
            // suspicious num is for counting the number of false num && define the range && result
            //  i) suspisious nums[] == Cm - K, range nums == Am_cm, result == o or x
            // falsethList
            //  i) Compare to other data which is enterd before and the results is o, and make the uncommon list == dataOi - dataOii
            // truethlist
            //  i) Compare to other data which is enterd before and the results is o, and make the uncommon list == dataOi - dataOii
            //  Compare falsethList to truethlist, and if there has comomon num , the ans is gonna be 0
            //  Define the smallest the result of o's data  - truthlist, and 
